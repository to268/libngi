...
void ngi_close(ngi_header_t* ngi_header) { ngi_header_free(ngi_header); }
...
FILE* ngi_get_file(const ngi_header_t* ngi_header) { return ngi_header->fd; }
